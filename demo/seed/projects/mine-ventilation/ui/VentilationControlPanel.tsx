// mine-ventilation â€” visual implementation behind ui/index.tsx
...
export default function VentilationControlPanel({ model, actions }: {
 ...
 return <div style={{ padding: 11, minHeight: "100%", background: "linear-gradient(180deg,#0A0D0F,#07090B)", color: "#EDF2F4" }}>
    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}><div><div style={{ fontSize: 12, fontWeight: 900 }}>VENTILATION CONTROL</div><div style={{ fontSize: 11, color: "#717B81", marginTop: 2 }}>Atmospheric demand â†’ primary + booster fans â†’ measured airflow</div></div><div style={{ textAlign: "right" }}><div style={{ fontSize: 11, fontWeight: 850, color }}>{manual ? "MANUAL BOOST" : boost ? "AUTO BOOST" : "DEMAND AUTO"}</div><div style={{ fontSize: 11, color: "#69747A" }}>{formatNumber(airflow, 0)} mÂ³/s</div></div></div>
