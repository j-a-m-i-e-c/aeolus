...
import { CommandProofCard, control, percent, rpm, temperature, toggleProps, watts } from "@aeolus/ui";
export default function SugarGliderDenPanel({ model, actions }: {
    ...
    {/* The outcome line above is the verdict; this is the tachometer reading it came
        from. Cooling claims are worth nothing here without the measured impeller speed,
