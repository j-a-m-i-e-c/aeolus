// demo/seed/project-loader.mjs — single source of truth for reading a demo
// Automation Project off disk.
//
// Demo manifests under demo/seed/tabs/ carry only metadata plus a
// `projectDir`; the authored Logic/UI lives under demo/seed/projects/<dir>/
 ...
 *
 * @param {string} projectDir directory name under demo/seed/projects/
