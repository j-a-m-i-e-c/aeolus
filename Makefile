...
reset: ## Wipe database and restart fresh (destroys all data)
	docker compose down
	rm -f data/aeolus.db
	docker compose up -d
	@echo "Database wiped. Create admin at http://localhost:3000, then run: make seed USER=admin PASS=yourpass"
